...
class Fighter extends Sprite {
  constructor({
    ...
    super({ position, imageSrc, scale, frameMax, frameHold, offset });
  ...
  update() {
    ...
    if (this.position.y + this.height + this.velocity.y >= canvas.height - 96) {
      this.velocity.y = canvas.height - 96 - (this.position.y + this.height);
    } else {
  ...
  switchSprite(sprite) {
    //override all other animations with death animation
